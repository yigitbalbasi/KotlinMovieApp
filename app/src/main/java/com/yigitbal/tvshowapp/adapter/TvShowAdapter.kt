package com.yigitbal.tvshowapp.adapter
...
import coil.load
import com.yigitbal.tvshowapp.TvShowItem
import com.yigitbal.tvshowapp.databinding.TvShowLayoutAdapterBinding

class TvShowAdapter : RecyclerView.Adapter<TvShowAdapter.MyViewHolder>() {

    inner class MyViewHolder(
        val binding:
        TvShowLayoutAdapterBinding
    ) :
